            ...
            <View className="px-4 py-6 bg-gray-800 rounded-2xl  mb-2 mx-4">
                ...
                <View className="flex-row items-center justify-between">
                    ...
                    <View className="flex-row items-center space-x-4">
                        ...
                        <TouchableOpacity
                            onPress={decrease}
                            className="w-8 h-8 mr-2 rounded-full bg-gray-200 items-center justify-center"
                        >
                        ...
                        <TouchableOpacity
                            onPress={increase}
                            className="w-8 h-8 mr-3 rounded-full bg-gray-200 items-center justify-center"
                        >
                            <Text className="text-lg font-bold">+</Text>
                        </TouchableOpacity>
                    </View>
